...
TFIDF_FILE = "entertainment_tfidf.pkl"
LDA_FILE = "entertainment_lda.pkl"
SVM_FILE = "entertainment_svm.pkl"
...
def predict_entertainment_label(headline, content):
    tfidf, lda, svm = load_entertainment_models()
