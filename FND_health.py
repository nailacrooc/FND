...
TFIDF_FILE = "health_tfidf.pkl"
LDA_FILE = "health_lda.pkl"
SVM_FILE = "health_svm.pkl"
...
def train_health_model():
    print("Training new health model...")

    df = pd.read_csv("C:/Users/johnj/ScrapyTest/ScrapyTest/FND-LATEST/FND/HEALTH-cleaned.csv", encoding="ISO-8859-1", on_bad_lines="skip")
    ...
    print(f"\n[Health] Accuracy: {accuracy_score(y_test, y_pred):.4f}")
...
def predict_health_label(headline, content):
    tfidf, lda, svm = load_health_models()
